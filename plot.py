...
# @click.option('-d', '--dim', type=int, default=1,
#               prompt='Please enter the number of dimensions:',
#               help='Soft Integral dimensions')
# @click.option('-b', '--bounds', type=str,
#               prompt='Please enter the classifier bounds:',
...
def plot(dim, bounds, n_points, range, show_hard):
    ...
    lower and upper bound of each axis together. Ex. for 2D:
